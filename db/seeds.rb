...
stat10 = Stat.create(title: 'Total Yards Allowed',          role: 'Defense')

stat11 = Stat.create(title: 'Defensive Touchdowns Scored',  role: 'Offense')
stat12 = Stat.create(title: 'Defensive Touchdowns Allowed', role: 'Defense')
