stat1  = Stat.create(title: 'Total TD Scored',      role: 'Offense')
stat2  = Stat.create(title: 'Total TD Allowed',     role: 'Defense')
...
stat6  = Stat.create(title: 'Pass TD Scored',       role: 'Offense')
stat7  = Stat.create(title: 'Pass Yards Gained',    role: 'Offense')
stat8  = Stat.create(title: 'Rush TD Scored',       role: 'Offense')
stat9  = Stat.create(title: 'Rush Yards Gained',    role: 'Offense')
stat10 = Stat.create(title: 'Total Yards Gained',   role: 'Offense')

stat11 = Stat.create(title: 'Pass TD Allowed',      role: 'Defense')
stat12 = Stat.create(title: 'Pass Yards Allowed',   role: 'Defense')
stat13 = Stat.create(title: 'Rush TD Allowed',      role: 'Defense')
stat14 = Stat.create(title: 'Rush Yards Allowed',   role: 'Defense')
stat15 = Stat.create(title: 'Total Yards Allowed',  role: 'Defense')

stat16 = Stat.create(title: 'Defensive TD Scored',  role: 'Offense')
stat17 = Stat.create(title: 'Defensive TD Allowed', role: 'Defense')
stat18 = Stat.create(title: 'Return TD Scored',     role: 'Offense')
stat19 = Stat.create(title: 'Return TD Allowed',    role: 'Defense')
