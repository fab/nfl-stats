...
stat1  = Stat.create(title: 'Total Touchdowns Scored',      type: 'offense')
stat2  = Stat.create(title: 'Passing Touchdowns Scored',    type: 'offense')
stat3  = Stat.create(title: 'Rushing Touchdowns Scored',    type: 'offense')
stat4  = Stat.create(title: 'Total Points Scored',          type: 'offense')
stat5  = Stat.create(title: 'Defensive Touchdowns Allowed', type: 'offense')

stat6  = Stat.create(title: 'Total Touchdowns Allowed',     type: 'defense')
stat7  = Stat.create(title: 'Passing Touchdowns Allowed',   type: 'defense')
stat8  = Stat.create(title: 'Rushing Touchdowns Allowed',   type: 'defense')
stat9  = Stat.create(title: 'Total Points Allowed',         type: 'defense')
stat10 = Stat.create(title: 'Defensive Touchdowns Scored',  type: 'defense')

stat11 = Stat.create(title: 'Return Touchdowns Scored',     type: 'special teams')
stat12 = Stat.create(title: 'Return Touchdowns Allowed',    type: 'special teams')
