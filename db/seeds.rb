...
stat6  = Stat.create(title: 'Pass Touchdowns Scored',       role: 'Offense')
stat7  = Stat.create(title: 'Pass Yards Gained',            role: 'Offense')
stat8  = Stat.create(title: 'Rush Touchdowns Scored',       role: 'Offense')
stat9  = Stat.create(title: 'Rush Yards Gained',            role: 'Offense')
stat10 = Stat.create(title: 'Total Yards Gained',           role: 'Offense')

stat11 = Stat.create(title: 'Pass Touchdowns Allowed',      role: 'Defense')
stat12 = Stat.create(title: 'Pass Yards Allowed',           role: 'Defense')
stat13 = Stat.create(title: 'Rush Touchdowns Allowed',      role: 'Defense')
